            ...
            steps {
                ...
                sshagent(['ssh-remote']) {
                    script {
                        ...
                        sh """ssh -l root $prod_ip -o StrictHostKeyChecking=no docker run --restart always --name train-schedule -p 8080:8080 -d cuong2811/train-schedule:${env.BUILD_NUMBER}"""
                    }
                }
            }
        }
